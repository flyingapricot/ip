...
public class Events extends Task {
   ...
   */
  public Events(String description, boolean isDone, String originalStartDateTimeString, String originalEndDateTimeString) throws OrangeException {
  ...
  public String GetTaskWithCompletion() {
    if (this.isDone) {
      return "[E][X] " + this.description + " (from: " + newStartDateTimeString + " to: " + newEndDateTimeString + ")";
    } else {
      return "[E][ ] " + this.description + " (from: " + newStartDateTimeString + " to: " + newEndDateTimeString + ")";
    }
  }
