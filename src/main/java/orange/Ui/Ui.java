...
/**
 * Provides user interface functionalities for the Orange chatbot. This class handles displaying
 * messages, tasks, and errors to the user.
 *
 * <p>The class contains methods for greeting the user, displaying task lists, showing success/error
...
public class Ui {
     ...
     *
     * <p>This method prints a welcome message to the user, introducing the chatbot.
     */
     ...
     *
     * <p>This method prints a farewell message to the user before exiting.
     */
     ...
     *
     * <p>This method prints the task details and updates the total task count.
     *
    ...
    public static void showAddTask(Task t) {
        ...
        System.out.println(
                "\tNow you have " + TaskList.getInstance().getSize() + " tasks in the list.");
        System.out.println(HORIZONTAL_LINE);
    }
    ...
    public static void showFoundTasks(ArrayList<Task> matchingTasks) {
        ...
        for (Task task : matchingTasks) {
            System.out.println("\t\t" + task.getTaskWithCompletion());
        }
        System.out.println(HORIZONTAL_LINE);
    }
    ...
    public static void showMatchingTasks(ArrayList<Task> matchingTasks, LocalDate checkDate) {
        System.out.println(HORIZONTAL_LINE);
        System.out.println(
                "Here are the list of tasks that are due on "
                        + DateParser.getStringFromLocalDate(checkDate));
