...
/**
 * The Orange class represents the main entry point of the Orange chatbot.
 * It initializes the necessary components and manages user input and command execution.
 *
 * <p>
 * The chatbot continuously listens for user input and processes commands
...
public class Orange {
  ...
  /**
   * Constructs an instance of the Orange chatbot.
   ...
   * <p>
   * The chatbot scans for commands, executes them, and handles exceptions
